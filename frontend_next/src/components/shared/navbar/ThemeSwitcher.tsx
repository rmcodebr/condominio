  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuTrigger>
        <DropdownMenuContent
          align="end"
          className="bg-babyPowder dark:bg-richBlack
            ...
            <DropdownMenuItem
              ...
              ${
                theme === "light" && value === "light"
                  ...
                  ? "text-blue-400"
                  : theme === "light"
                  ? "text-richBlack hover:text-babyPowder"
                  : "text-babyPowder"
              }`}
            >
              {label}
